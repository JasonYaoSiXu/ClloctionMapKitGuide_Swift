...
class UserNotification: NSObject {
    ...
    class func registerUserNotification() {
         ...
         */
        let userNotificationEnterGeographicalActionOne = UNNotificationAction(identifier: "userNotificationEnterGeographicalActionOne", title: "查看", options: [.authenticationRequired, .foreground])
        let userNotificationEnterGeographicalActionTwo = UNNotificationAction(identifier: "userNotificationEnterGeographicalActionTwo", title: "删除", options: [.destructive])
        /**
            定义一个通知类型
         ...
         */
        let userNotificationEnterGeographicalCategor = UNNotificationCategory(identifier: CateGeographicalIdentifier.categorEnterGeographical.rawValue, actions: [userNotificationEnterGeographicalActionOne,userNotificationEnterGeographicalActionTwo], intentIdentifiers: [], options: [])
        
        //将自已定的通知类型添加到userNotificationCenter
        userNotificationCenter.setNotificationCategories([userNotificationEnterGeographicalCategor])
    }
